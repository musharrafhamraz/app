...
import Card from "../Components/annoucements";
      ...
      {label ? (
        ...
        <View>
          <View style={{ flex: 0.91 }}>
            ...
            <Text style={styles.commonDisease}>Annoucements</Text>
            <View style={styles.Gridcontainercontainer}>
              <View style={styles.row}>

                <Card imgPath={require('../assets/images/wheatharvest.jpg')}
                  Date='21'
                  Month='June'
                  reason='Happy Harvesting'
                />
                <Card imgPath={require('../assets/images/potato.jpg')}
                  Date='12'
                  Month='Febraury'
                  reason='Happy growing'
                />

              </View>
              <View style={styles.row}>
                <Card imgPath={require('../assets/images/tomato.jpg')}
                  Date='17'
                  Month='March'
                  reason='Happy growing'
                />
                <Card imgPath={require('../assets/images/corn.jpg')}
                  Date='25'
                  Month='October'
                  reason='Happy Harvesting'
                />
